...
const Sidebar = () => (
    <div className='nav-bar'>
        ...
        <nav>
            ...
            <NavLink exact="true" activeclassname="active" className="portfolio-link" to="/project">
        ...
        <ul>
            <li>
                <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/hanif-nahan">
